...
main(int argc, char** argv)
{
  ...
  return app.run(argc, argv, [&] {
    return seastar::async([&] {
      ...
      //      // On my machine Seastar reports that each core has 1GB free
      //      memory.
      //      // leave 64MB for temporary buffers and also reserve a little bit
      //      more
      //      // to be sure that we don't hit the limit while allocating
      //      supplementary
